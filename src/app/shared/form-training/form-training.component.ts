...
export class FormTrainingComponent {
  ...
  IniciarEntrenamiento() {
    ...
    this.leerExcel(this.form.get('banco')?.value).then(() => {
      ...
      this.entrenamientoServicio.entrenamiento(
        ...
        this.pesos,
        this.umbral,
        this.form.get('iterations')?.value != null ? this.form.get('iterations')?.value! : 0,
        this.form.get('learningRate')?.value != null ? this.form.get('learningRate')?.value! : 0,
        this.form.get('maxError')?.value != null ? this.form.get('maxError')?.value! : 0,
        this.entradas,
        this.salidas,
        this.form.get('function2')?.value != null ? this.form.get('function2')?.value! : "", //codigo de la funcion activacion
        this.form.get('function1')?.value != null ? this.form.get('function1')?.value! : "" // codigo del algoritmo de entrenamiento
      );
  ...
  constructor(private funciones:FunctionsService, private excelService: ExcelService,
